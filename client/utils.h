...
extern "C" void HUD_TempEntUpdate( double frametime, double client_time, double cl_gravity, struct tempent_s **ppTempEntFree,
...
extern "C" int HUD_AddEntity( int type, struct cl_entity_s *ent, const char *modelname );
extern "C" void HUD_TxferLocalOverrides( struct entity_state_s *state, const struct clientdata_s *client );
extern "C" void HUD_ProcessPlayerState( struct entity_state_s *dst, const struct entity_state_s *src );
extern "C" void HUD_TxferPredictionData( entity_state_t *ps, const entity_state_t *pps, clientdata_t *pcd, const clientdata_t *ppcd, weapon_data_t *wd, const weapon_data_t *pwd );
extern "C" void HUD_StudioEvent( const struct mstudioevent_s *event, const struct cl_entity_s *entity );
extern "C" void HUD_CreateEntities( void );
...
extern "C" void *KB_Find( const char *name );
extern "C" void CL_CreateMove( float frametime, struct usercmd_s *cmd, int active );

extern "C" int HUD_GetRenderInterface( int version, render_api_t *renderfuncs, render_interface_t *callback );
extern "C" int HUD_GetStudioModelInterface( int version, struct r_studio_interface_s **ppinterface, struct engine_studio_api_s *pstudio );
...
extern "C" void V_CalcRefdef( struct ref_params_s *pparams );
